    ...
    <div className="h-full w-full bg-background overflow-auto">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="text-center mb-8">
          <h1 
            className="font-fredoka text-primary-700 mb-2"
            style={{ fontSize: `${Math.max(textSize + 4, 28)}px` }}
          >
            {glossary.title}
          </h1>
          <div className="w-24 h-1 bg-primary-700 mx-auto rounded"></div>
        </div>
          ...
          <div className="divide-y divide-gray-200">
            {glossary.terms.map((term, index) => (
              <div key={term.id} className="relative">
                <div className={`grid grid-cols-12 gap-4 p-4 transition-colors hover:bg-primary-50 ${
                  ...
                  <div className="col-span-2 flex items-center">
                    <div className="flex items-center space-x-2">
                      <span 
                        ...
                        style={{ fontSize: `${Math.max(textSize - 4, 18)}px` }}
                      >
                        {index + 1}.
                      </span>
                      <span 
                  ...
                  <div className="col-span-5 flex items-center">
                    <p 
                      ...
                      style={{ fontSize: `${Math.max(textSize - 8, 16)}px` }}
                    >
                      {term.definition}
                    </p>
                  </div>
                  ...
                  <div className="col-span-1 flex items-center justify-center">
                    ...
                    >
                      {playingAudio === term.id ? (
                        <PauseIcon className="w-5 h-5 text-primary-700" />
                      ) : (
                        <Volume2Icon className="w-5 h-5 text-primary-700" />
                      )}
                    </button>
        ...
        <div className="mt-8 text-center text-gray-600">
          <p style={{ fontSize: `${Math.max(textSize - 12, 14)}px` }}>
